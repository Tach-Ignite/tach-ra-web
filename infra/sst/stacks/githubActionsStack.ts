...
export function GithubActionsStack(
  ...
  if (app.stage === 'prod') {
    ...
    const organization = githubRepoOwner; // Use your GitHub organization
    const repository = githubRepoName; // Use your GitHub repository
